...
void CTimeMgr::render()
{
	...
	Vec3 vUIMousePos = CKeyMgr::GetInst()->GetUIMousePos();

	if (1.f <= m_fTime)
	{		
		swprintf_s(szBuff, L"FPS : %d, DT : %f, MOUSE_POS_X : %f , MOUSE_POS_Y : %f", m_iCallCount, m_fDeltaTime, vUIMousePos.x, vUIMousePos.y);
